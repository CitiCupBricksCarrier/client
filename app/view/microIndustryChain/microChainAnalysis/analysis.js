angular.module('myApp.microIndustryChain.analysis', [
    'ngAnimate', 'ui.bootstrap','myApp.microIndustryChain.publicOpinion','myApp.microIndustryChain.peAnalysis'
])
    .controller('AnalysisCtrl', function ($scope, $uibModal, $uibModalInstance, items) {
        ...
        let controllers=["PublicOpinionCtrl","PeAnalysisCtrl"];

        let methods=["opinion","pe"]
